...
async def cmd_start(message: Message, state: FSMContext):
    ...
    welcome_text = (
        ...
        f"🔑 <b>Первый шаг:</b> Добавьте свой API ключ Gemini\n"
        f"Нажмите кнопку \"🔑 Мой API ключ\" и следуйте инструкциям.\n"
        f"Это бесплатно и займёт пару минут!\n\n"
        f"📝 После настройки ключа нажмите \"Создать документ\"\n\n"
...
async def cmd_help(message: Message):
    ...
    help_text = (
        ...
        "🔑 Нажмите кнопку \"Мой API ключ\" для настройки\n"
        "• Получите бесплатный ключ на https://aistudio.google.com/app/apikey\n"
        "• Добавьте ключ в бот\n"
        "• Ваш ключ будет безопасно сохранён\n\n"
        
        "<b>Как создать документ:</b>\n"
        "1️⃣ Убедитесь, что API ключ настроен\n"
        "2️⃣ Нажмите кнопку \"📝 Создать документ\" или введите /generate\n"
        "3️⃣ Выберите тип шаблона документа\n"
        "4️⃣ Опишите, какой документ вам нужен\n"
        "5️⃣ Выберите формат (Word или PDF)\n"
        "6️⃣ Дождитесь генерации и получите готовый документ\n"
        "7️⃣ При необходимости нажмите \"✏️ Редактировать\" и опишите изменения\n\n"
